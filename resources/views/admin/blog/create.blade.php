<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">Add Blog Post</h2>
    </x-slot>
                ...
                <div class="p-6">
                    ...
                    <form method="POST" action="{{ route('admin.blog.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="excerpt" class="w-full border rounded p-2">{{ old('excerpt') }}</textarea>
                        </div>

                        <div class="mb-4">
                            <label class="block text-sm font-medium text-gray-700">Content</label>
                            <textarea name="content" class="w-full border rounded p-2" rows="8">{{ old('content') }}</textarea>
                        </div>
