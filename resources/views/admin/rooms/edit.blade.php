                ...
                <div class="p-6">
                    ...
                    <form method="POST" action="{{ route('admin.rooms.update', $room) }}" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" name="capacity" min="1" value="{{ old('capacity', $room->capacity) }}" class="w-full border rounded p-2" required>
                        </div>

                        <div class="mb-4">
                            <label class="block text-sm font-medium text-gray-700">Price per night</label>
                            <input type="number" step="0.01" name="price_per_night" value="{{ old('price_per_night', $room->price_per_night) }}" class="w-full border rounded p-2" required>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            @if($room->image_path)
                                <div class="mt-2">
                                    <img src="{{ $room->image_url }}" alt="room" class="h-24 object-cover">
                                </div>
                            @endif
                        </div>
                        ...
                        <div class="mb-6">
                            ...
                            <select name="status" class="w-full border rounded p-2" required>
                                <option value="active" @selected(old('status', $room->status)==='active')>active</option>
